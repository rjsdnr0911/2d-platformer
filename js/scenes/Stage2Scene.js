...
class Stage2Scene extends Phaser.Scene {
    ...
    updateUI() {
        ...
        if (this.killCountText) {
            this.killCountText.setText(`[퀘스트] 유령 ${this.killCount}/${this.totalEnemies}마리 처치`);
        }
    ...
    spawnBoss() {
        ...
        this.tweens.add({
            ...
            onComplete: () => {
                ...
                // 경고 텍스트
                const warningMsg = this.add.text(spawnX, spawnY - 50, '⚠️ WARNING: RAGING RHINO ⚠️', {
                    fontSize: '24px',
                    fill: '#ff0000',
                    fontStyle: 'bold',
                    stroke: '#000',
                ...
                this.tweens.add({
                    ...
                    onComplete: () => {
                        ...
                        try {
                            ...
                            // 보스 생성
                            this.boss = new RinoBossClass(this, spawnX, spawnY);
